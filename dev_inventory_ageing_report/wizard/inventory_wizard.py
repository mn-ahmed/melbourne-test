...
class inventory_wizard(models.TransientModel):
    ...
    _description = 'Inventory Age Wizard'
    ...
    def create_table_values(self, worksheet, text_left, text_right, row, res, product_ids, text_right_bold):
        ...
        for product in product_ids:
            ...
            if stock_qty != 0:
                ...
                worksheet.write_merge(row, row, 0, 0, product.default_code or '', text_left)
                ...
                worksheet.write(row, 4, stock_qty or ' ', text_right)
                # worksheet.write(row, 5, stock_qty * product.qty_available, text_right)
                ...
                for i in range(7)[::-1]:
                    ...
                    worksheet.write(row, col, qty, text_right)
                    col += 1
